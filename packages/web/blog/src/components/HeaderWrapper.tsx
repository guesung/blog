...
export default function HeaderWrapper({
  ...
  return (
    <div
      className={cn(
        'text-body2 bg-white-1 max-w-800 border-b-1 fixed inset-x-0 top-0 z-10 mx-auto transform px-20 py-4 shadow-sm transition-transform duration-300 ease-in-out',
